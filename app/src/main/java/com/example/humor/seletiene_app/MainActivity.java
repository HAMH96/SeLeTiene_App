...
public class MainActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position){
                case 0: LibreriasFragment tab1 = new LibreriasFragment();
                    return tab1;
                case 1: ContactosFragment tab2 = new ContactosFragment();
                    return tab2;
                case 2: PrestamosFragment tab3 = new PrestamosFragment();
                    return tab3;
                default: return null;
            }
        }
